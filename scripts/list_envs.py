...
All the environments are registered in the `washingspider` extension. They start
...
import washingspider.tasks  # noqa: F401


def main():
    """Print all environments registered in `washingspider` extension."""
